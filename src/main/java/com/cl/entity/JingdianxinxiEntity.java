...
public class JingdianxinxiEntity<T> implements Serializable {
	 ...
	 * 设置：门票链接
	 */
	public void setMenpiaolianjie(String menpiaolianjie) {
		this.menpiaolianjie = menpiaolianjie;
	}
	/**
	 * 获取：门票链接
	 */
	public String getMenpiaolianjie() {
		return menpiaolianjie;
	}
	/**
	 * 设置：景点类型
	 */
	 ...
	 * 设置：路线推荐
	 */
	public void setLuxiantuijian(String luxiantuijian) {
		this.luxiantuijian = luxiantuijian;
	}
	/**
	 * 获取：路线推荐
	 */
	public String getLuxiantuijian() {
		return luxiantuijian;
	}
	/**
	 * 设置：景点介绍
	 */
